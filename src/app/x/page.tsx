      ...
      <div>
        ...
        <div className="flex flex-col  ml-4 mx-auto">
          <div className=" flex  gap-x-4 border-b border-gray-800">
            <p className=" text-white border-b border-gray-800 pt-4 pb-2 font-black font-sans text-2xl">
              Diễn viên
            </p>
            <p className=" text-white border-b border-gray-800 pt-4 pb-2  font-black font-sans text-2xl">
              Đề xuất
                  ...
                  <div className="flex w-[95%]  items-center   gap-x-4">
                    <div className="flex flex-col w-full  text-white font-semibold hover:text-green-500">
                      <Image
                        ...
                        src={Focus2}
                      />
                      <p className="truncate w-44   mt-4 ">
                        Tam Tuyến Luân Hồi
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col w-full">
                      <Image
                        ...
                        src={Focus2}
                      />
                      <p className="truncate w-44 text-white mt-4 ">
                        Tam Tuyến Luân Hồi
                      </p>
                    </div>
                  </div>
